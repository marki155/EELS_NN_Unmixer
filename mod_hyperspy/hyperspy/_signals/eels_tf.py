...
from hyperspy.components1d import PowerLaw_TF
...
class EELSSpectrum_TF(Signal1D):
    ...
    def fourier_ratio_deconvolution(self, ll,
        ...
        from hyperspy.components1d import Gaussian_TF
        g = Gaussian()
    ...
    def create_model(self, ll=None, auto_background=True, auto_add_edges=True,
        ...
        NotImplementedError
            If the signal axis is a non-uniform axis.
        """
        from hyperspy.models.eelsmodel_tf import EELSModel_TF
...
class LazyEELSSpectrum(EELSSpectrum_TF, LazySignal1D):
